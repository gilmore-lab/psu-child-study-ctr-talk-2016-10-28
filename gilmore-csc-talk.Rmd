...
- "Reproducible" workflows not standard practice; results have limited robustness and generalizability.
...
## Working with the community essential to change practices

- Journals don't always encourage/support/mandate publication of data, detailed methods
- Better if we solve this ourselves than suffer a mandate
...
<div class="centered">
<img src="img/databrary-splash.jpg" width=800px>
</div>

## When asked, most participants say yes {.flexbox .vcenter}
...
## People will *volunteer* information we have to pay to get {.flexbox .vcenter}
...
## Videos of procedures will boost methodological reproducibility

- We just have to record and share them
- Databrary will store them

## We also need better tools, training {.flexbox .vcenter}
...
## And, we need to think bigger... {.flexbox .vcenter}
